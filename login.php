...
<body class="background-gradient">
    <div class="pane">
        ...
        <div class="loginForm">
            <div class="formItem">
                <label for="username"></label><i class="gradient-text fa fa-user"></i><input type="text" autocomplete="username" id="username" name="username" placeholder="Username" size="20" maxlength="40">
            </div>
            <div class="formItem">
